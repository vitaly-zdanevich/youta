...
///
/// Only the resolvers that are given a deadline are supervised this way. mpv is
/// not: it is meant to receive the terminal's own interrupt.
#[cfg(feature = "yt-dlp")]
...
#[cfg(any(all(windows, feature = "yt-dlp"), test))]
mod windows_kill {
