...
IUSE="
	...
	+funkwhale +generic-ytdlp google-drive gpodder +invidious jack +jamendo keyring
	...
	sponsorblock ssh telegram test +thumbnails torrent +tracker-music +tui +vimeo vk
	waveform webdav wikidata wikimedia yandex-disk yandex-music +youtube-official
	+yt-dlp
"

REQUIRED_USE="
	apple-podcasts? ( rss )
	bbc-radio? ( radio yt-dlp )
	gpodder? ( rss )
...
RDEPEND="
	!bundled-sqlite? ( dev-db/sqlite:3 )
