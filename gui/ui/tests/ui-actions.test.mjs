...
test('UiAction rejects unknown names, incorrect payloads, null identities and multiple tags', () => {
	const invalid = [
		...
		'{ SelectYouTubeSetupField: \'ApiSecret\' }',
		'{ SelectInvidiousInstance: \'first\' }',
		'{ OpenYouTubeProviderSettings: true }',
		'{ SelectDownloadChoice: { generation: 1 } }',
		'{ SelectDownloadChoice: { generation: null, index: 0 } }',
		'{ SelectArchivePlaybackChoice: { generation: 1 } }',
		'{ SelectArchivePlaybackChoice: { generation: null, index: 0 } }',
		'{ SelectArchivePlaybackChoice: { generation: 1, index: 0, url: \'https://example.test/file.mp3\' } }',
		'{ ConfirmArchivePlaybackChoice: \'1\' }',
		'{ MoveArchivePlaybackChoice: null }',
